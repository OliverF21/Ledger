...
Installers are on the **[Releases](https://github.com/OliverF21/Ledger/releases/latest)** page. You don't need Python or Node for the desktop build. The marketing site is **[OliverF21/ledger-website](https://github.com/OliverF21/ledger-website)** (Vercel: import that repo, root `.`).
