    ...
    <header className="glass-header px-5 short:px-6 tall:px-7 py-3 short:py-[14px] tall:py-[18px] flex items-center justify-between shrink-0">
      ...
      <div className="flex items-center gap-2.5">
        <button
          ...
          className="flex items-center gap-1.5 glass-chip text-ledger-text-primary px-3.5 py-2 font-semibold text-sm cursor-pointer hover:brightness-110"
        >
          Link Account
        </button>
        ...
        <button
          onClick={handleSync}
          disabled={isSyncing}
          className="flex items-center gap-1.5 bg-ledger-accent text-ledger-accent-on border-none rounded-lg px-3.5 py-2 font-semibold text-sm cursor-pointer hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          <RefreshCw
        ...
        <button
          ...
          className="w-9 h-9 rounded-full bg-gradient-to-br from-[#3a4252] to-[#222632] flex items-center justify-center text-sm font-bold text-[#cdd2da] hover:opacity-80 cursor-pointer"
        >
          {initials(name)}
        </button>
      </div>
